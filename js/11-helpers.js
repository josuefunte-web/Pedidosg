...
// Unidades ofrecidas al hacer un pedido. Deben coincidir SIEMPRE en las tres
// rutas que dibujan la fila de unidades (render inicial, buscador de
// productos y +/- de cantidad) — si divergen, un producto ya puesto en
// "Caja" puede perder ese botón al usar el buscador y parecer que se ha
// reseteado a KG aunque el dato guardado (S.cartUnits) seguía intacto.
const ORDER_UNITS=['KG','L','UN','Caja'];
// ── Escapes anti-XSS ─────────────────────────────────────────────────
